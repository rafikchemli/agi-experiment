...
class SparseCodingV4(MNISTApproach):
    """Sparse predictive coding v4 — tuned hyperparameters (92.7% snapshot).

    Same architecture as PredictiveCoding but with optimized parameters:
    - Lower sparsity (0.05 vs 0.3) — more active features per image
    - Better convergence within 25 epochs
